...
# import sys
# sys.path.append('C:\\espressif\\v4.4-rc1\\esp-idf\\tools\\')
# sys.path.append('C:\\espressif\\v4.4-rc1\\esp-idf\\tools\\ci\\python_packages')

import ttfw_idf


@ttfw_idf.idf_example_test(env_tag='Example_GENERIC', target=['esp32', 'esp32c3', 'esp32s3'])
