...
/**
 * @brief 'deep_sleep'命令将芯片置于深度睡眠模式
 * 
 */
static struct {
...
/**
 * @brief 'light_sleep'命令将芯片置于轻睡眠模式
 * 
 */
static struct {
    struct arg_int *wakeup_time;
