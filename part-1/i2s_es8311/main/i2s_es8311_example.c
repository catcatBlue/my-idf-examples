...
#define EXAMPLE_RECV_BUF_SIZE   (4096)/* 2048 */
#define EXAMPLE_SAMPLE_RATE     (32000)/* (16000) */
#define EXAMPLE_MCLK_MULTIPLE   I2S_MCLK_MULTIPLE_256 /* I2S_MCLK_MULTIPLE_256 */
...
void app_main(void)
{
    ...
    xTaskCreate(i2s_music, "i2s_music", 8192, NULL, 5, NULL);
#else
