...
#define TFT_SPI_HOST /* SPI3_HOST */SPI2_HOST/* HSPI_HOST */
#elif defined (CONFIG_LV_TFT_DISPLAY_SPI_VSPI)
#define TFT_SPI_HOST /* SPI3_HOST */SPI2_HOST/* VSPI_HOST */
#elif defined (CONFIG_LV_TFT_DISPLAY_SPI_FSPI)
#define TFT_SPI_HOST /* SPI3_HOST */SPI2_HOST/* FSPI_HOST */
#endif
...
#define TOUCH_SPI_HOST SPI2_HOST/* VSPI_HOST */
#elif defined (CONFIG_LV_TOUCH_CONTROLLER_SPI_FSPI)
#define TOUCH_SPI_HOST SPI2_HOST/* FSPI_HOST */
#endif
